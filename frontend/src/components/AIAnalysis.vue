...
<!--          <div class="p-4 rounded-lg" :class="getSentimentColor(analysis.sentiment)">-->
<!--            <h4 class="font-medium mb-2">Market Sentiment</h4>-->
<!--            <p class="text-sm">{{ analysis.sentiment_summary }}</p>-->
<!--          </div>-->
...
llte das Market Sentiment wieder korrekt anzeigen, mit einem Fallback falls die AI keine spezifische Zusammenfassung liefert.